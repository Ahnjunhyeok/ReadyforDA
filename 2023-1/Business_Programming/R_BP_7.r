...
x <- read.csv("C:/Users/ahnjh/Desktop/R/r_practice/reservation_r_csv.csv", header = TRUE, fileEncoding = "CP949", encoding = "UTF-8") # 인코딩 필요
...
y <- read_excel("C:/Users/ahnjh/Desktop/R/r_practice/reservation_r_excel.xlsx")
